...
(function() {
  var DEBUG, GRP_LIST, Sudoku, check, debug_log, indexOf, _g, _gx, _gy, _i, _x, _y;
  ...
  Sudoku = (function() {
    ...
    Sudoku.solve = function(q) {
      ...
      if (solved) {
        ...
        return this.solve_backtrack(q_r);
      }
    };
    ...
    Sudoku.solve_backtrack = function(q) {
      var ans, count, cur, i, qid, qpos, ret, val, _j, _k;
      ans = [];
      cur = 0;
      val = 1;
      count = 0;
